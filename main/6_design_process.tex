...
\vspace{-0.5em}
First up, for easy processing and analysis, a parameterized Python file was coupled to \LaTeX \; and LTSpice such that this entire document can be automatically generated with all graphs, annotations and other values by only changing the variables $S_{a}$, $R_{34}$, $R_{mp}$, $I_{bmain}$ and $C_{in}$ (see \url{https://github.com/SjdTl/HW2}). 
